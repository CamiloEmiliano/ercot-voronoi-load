...
SCRIPT_PATH = Path(__file__).parents[1] / "scripts" / "download_asos_weather_tx.py"
SPEC = importlib.util.spec_from_file_location("download_asos_weather_tx", SCRIPT_PATH)
