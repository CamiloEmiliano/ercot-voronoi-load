"""Download archived New Mexico ASOS weather observations from Iowa Mesonet."""
...
LAND_STATION_IDS = (
    "0E0", "4MR", "ABQ", "AEG", "ALM", "ATS", "AXX", "CAO", "CNM", "CQC", "CVN", "CVS",
    "DMN", "DNA", "FMN", "GNT", "GUP", "HMN", "HOB", "LAM", "LRU", "LVS", "ONM", "ROW",
    "RTN", "SAF", "SRR", "SVC", "TCC", "TCS",
)

def build_request_url(start_date: date, end_date: date) -> str:
    """Build a UTC request for the selected New Mexico land stations."""
...
def main() -> None:
    ...
    for period_index, (start_date, end_date) in enumerate(periods):
        destination = output_dir / f"nm_asos_land_{start_date:%Y_%m}.csv"
