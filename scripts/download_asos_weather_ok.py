"""Download archived Oklahoma ASOS weather observations from Iowa Mesonet."""
...
LAND_STATION_IDS = (
    "1F0", "4O4", "ADH", "ADM", "AVK", "AXS", "BKN", "BVO", "CHK", "CLK", "CQB", "CSM",
    "CUH", "DUA", "DUC", "ELK", "END", "FDR", "FSI", "GAG", "GCM", "GMJ", "GOK", "GUY",
    "GZL", "HBR", "JSV", "JWG", "LAW", "LTS", "MKO", "MLC", "OJA", "OKC", "OKM", "OUN",
    "PNC", "PVJ", "PWA", "RCE", "RKR", "RQO", "RVS", "SNL", "SRE", "SWO", "TIK", "TQH",
    "TUL", "WDG", "WWR",
)

def build_request_url(start_date: date, end_date: date) -> str:
    """Build a UTC request for the selected Oklahoma land stations."""
...
def main() -> None:
    ...
    for period_index, (start_date, end_date) in enumerate(periods):
        destination = output_dir / f"ok_asos_land_{start_date:%Y_%m}.csv"
