"""Download archived Arkansas ASOS weather observations from Iowa Mesonet."""
...
LAND_STATION_IDS = (
    "4M9", "ADF", "ARG", "ASG", "AWM", "BPK", "BVX", "CCA", "CDH", "DEQ", "ELD", "FLP",
    "FSM", "FYV", "HKA", "HOT", "HRO", "JBR", "LIT", "LLQ", "LRF", "M19", "MEZ", "MWT",
    "PBF", "ROG", "RUE", "SGT", "SLG", "SRC", "TXK", "VBT", "XNA",
)

def build_request_url(start_date: date, end_date: date) -> str:
    """Build a UTC request for the selected Arkansas land stations."""
...
def main() -> None:
    ...
    for period_index, (start_date, end_date) in enumerate(periods):
        destination = output_dir / f"ar_asos_land_{start_date:%Y_%m}.csv"
